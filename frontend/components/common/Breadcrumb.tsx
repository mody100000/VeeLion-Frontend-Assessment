...
// Checks if a segment looks like an ID (e.g. uuid, numeric, or short hash) ==> treat as "Task Details"
...
export default function Breadcrumb() {
  ...
  return (
    <nav className="invisible md:visible flex items-center text-lg gap-x-1.5 p-4 sm:px-6">
      <Link
        href="/"
        className="text-[#71717A] hover:underline flex items-center gap-1"
      >
        Home
      </Link>
